...
int main(int argc, char ** argv) {
	...
	*/
	...
	//	  Y      inst             cible             decale-future
		{4096, FILTRES_PRIXS, 	CIBLE_NORMALE, NULL},
		{16,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
		//
		{64,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
		{64,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
		{64,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
		{64,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
		{64,  DOT1D_TANH,             	CIBLE_NORMALE, NULL},
	...
	//			    Source,      Nature,  K_ema, Intervalle,     {params}
		...
		cree_ligne(SRC_PRIXS, DIRECT, 1, 8, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 1, 1, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 1, 2, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 1, 8, cree_DIRECTE()),
		...
		cree_ligne(SRC_PRIXS, DIRECT, 2, 1.0, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 2, 2, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 2, 16, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 4, 1.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_PRIXS, DIRECT, 4, 32, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 8, 2.0, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 8, 8, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 8, 16, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 8, 64, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 8, 16, cree_DIRECTE()),
		...
		cree_ligne(SRC_PRIXS, DIRECT, 16, 128, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 32, 8.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_PRIXS, DIRECT, 32, 256, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 64, 16.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_PRIXS, DIRECT, 128, 32.0, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 128, 64.0, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 128, 128, cree_DIRECTE()),
		cree_ligne(SRC_PRIXS, DIRECT, 256, 64.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 1, 8, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 1, 1, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 1, 2, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 1, 8, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 2, 1.0, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 2, 2, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 2, 16, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 4, 1.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 4, 32, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 8, 2.0, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 8, 8, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 8, 16, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 8, 64, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 8, 16, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 16, 128, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 32, 8.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 32, 256, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 64, 16.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_HIGH, DIRECT, 128, 32.0, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 128, 64.0, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 128, 128, cree_DIRECTE()),
		cree_ligne(SRC_HIGH, DIRECT, 256, 64.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 1, 8, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 1, 1, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 1, 2, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 1, 8, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 2, 1.0, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 2, 2, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 2, 16, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 4, 1.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 4, 32, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 8, 2.0, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 8, 8, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 8, 16, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 8, 64, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 8, 16, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 16, 128, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 32, 8.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 32, 256, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 64, 16.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_LOW, DIRECT, 128, 32.0, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 128, 64.0, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 128, 128, cree_DIRECTE()),
		cree_ligne(SRC_LOW, DIRECT, 256, 64.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 1, 8, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 1, 1, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 1, 2, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 1, 8, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 2, 1.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 2, 2, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 2, 16, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 4, 1.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 4, 32, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 8, 2.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 8, 8, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 8, 16, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 8, 64, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 8, 16, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 16, 128, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 32, 8.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 32, 256, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 64, 16.0, cree_DIRECTE()),
		...
		cree_ligne(SRC_VOLUMES, DIRECT, 128, 32.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 128, 64.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 128, 128, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 256, 64.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 256, 128.0, cree_DIRECTE()),
		cree_ligne(SRC_VOLUMES, DIRECT, 256, 256, cree_DIRECTE()),
	// -------
		cree_ligne(SRC_PRIXS, MACD, 1, 1, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 1, 2, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 1, 2, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 1, 8, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 1, 8, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 1, 8, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 1, 8, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 2, 1.0, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 2, 2, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 2, 2, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 2, 4, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 2, 4, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 2, 4, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 2, 16, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 2, 16, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 2, 16, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 2, 16, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 4, 2.0, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 4, 2.0, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 4, 4, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 4, 4, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 4, 4, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 4, 8, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 4, 8, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 4, 8, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 4, 32, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 4, 32, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 4, 32, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 8, 4.0, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 8, 4.0, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 8, 8, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 8, 8, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 8, 16, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 8, 16, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 8, 16, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 8, 16, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 8, 64, cree_MACD(64)),
		cree_ligne(SRC_PRIXS, MACD, 16, 8.0, cree_MACD(1)),
		cree_ligne(SRC_PRIXS, MACD, 16, 16, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 16, 16, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 16, 16, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 16, 32, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 16, 32, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 16, 32, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 16, 32, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 16, 128, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 16, 128, cree_MACD(64)),
		cree_ligne(SRC_PRIXS, MACD, 16, 128, cree_MACD(128)),
		cree_ligne(SRC_PRIXS, MACD, 32, 16.0, cree_MACD(2)),
		cree_ligne(SRC_PRIXS, MACD, 32, 16.0, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 32, 16.0, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 32, 16.0, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 32, 32, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 32, 32, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 32, 32, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 32, 32, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 32, 64, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 32, 64, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 32, 64, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 32, 256, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 32, 256, cree_MACD(64)),
		cree_ligne(SRC_PRIXS, MACD, 32, 256, cree_MACD(128)),
		cree_ligne(SRC_PRIXS, MACD, 32, 256, cree_MACD(256)),
		cree_ligne(SRC_PRIXS, MACD, 64, 32.0, cree_MACD(4)),
		cree_ligne(SRC_PRIXS, MACD, 64, 32.0, cree_MACD(8)),
		cree_ligne(SRC_PRIXS, MACD, 64, 32.0, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 64, 32.0, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 64, 64, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 64, 64, cree_MACD(64)),
		cree_ligne(SRC_PRIXS, MACD, 64, 128, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 64, 128, cree_MACD(64)),
		cree_ligne(SRC_PRIXS, MACD, 64, 128, cree_MACD(128)),
		cree_ligne(SRC_PRIXS, MACD, 256, 128.0, cree_MACD(16)),
		cree_ligne(SRC_PRIXS, MACD, 256, 128.0, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 256, 128.0, cree_MACD(128)),
		cree_ligne(SRC_PRIXS, MACD, 256, 256, cree_MACD(32)),
		cree_ligne(SRC_PRIXS, MACD, 256, 256, cree_MACD(128)),
		cree_ligne(SRC_PRIXS, MACD, 256, 256, cree_MACD(256)),
		cree_ligne(SRC_HIGH, MACD, 1, 1, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 1, 2, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 1, 2, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 1, 8, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 1, 8, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 1, 8, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 1, 8, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 2, 1.0, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 2, 2, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 2, 2, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 2, 4, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 2, 4, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 2, 4, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 2, 16, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 2, 16, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 2, 16, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 2, 16, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 4, 2.0, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 4, 2.0, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 4, 4, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 4, 4, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 4, 4, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 4, 8, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 4, 8, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 4, 8, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 4, 32, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 4, 32, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 4, 32, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 8, 4.0, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 8, 4.0, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 8, 8, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 8, 8, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 8, 16, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 8, 16, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 8, 16, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 8, 16, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 8, 64, cree_MACD(64)),
		cree_ligne(SRC_HIGH, MACD, 16, 8.0, cree_MACD(1)),
		cree_ligne(SRC_HIGH, MACD, 16, 16, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 16, 16, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 16, 16, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 16, 32, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 16, 32, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 16, 32, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 16, 32, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 16, 128, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 16, 128, cree_MACD(64)),
		cree_ligne(SRC_HIGH, MACD, 16, 128, cree_MACD(128)),
		cree_ligne(SRC_HIGH, MACD, 32, 16.0, cree_MACD(2)),
		cree_ligne(SRC_HIGH, MACD, 32, 16.0, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 32, 16.0, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 32, 16.0, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 32, 32, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 32, 32, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 32, 32, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 32, 32, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 32, 64, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 32, 64, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 32, 64, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 32, 256, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 32, 256, cree_MACD(64)),
		cree_ligne(SRC_HIGH, MACD, 32, 256, cree_MACD(128)),
		cree_ligne(SRC_HIGH, MACD, 32, 256, cree_MACD(256)),
		cree_ligne(SRC_HIGH, MACD, 64, 32.0, cree_MACD(4)),
		cree_ligne(SRC_HIGH, MACD, 64, 32.0, cree_MACD(8)),
		cree_ligne(SRC_HIGH, MACD, 64, 32.0, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 64, 32.0, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 64, 64, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 64, 64, cree_MACD(64)),
		cree_ligne(SRC_HIGH, MACD, 64, 128, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 64, 128, cree_MACD(64)),
		cree_ligne(SRC_HIGH, MACD, 64, 128, cree_MACD(128)),
		cree_ligne(SRC_HIGH, MACD, 256, 128.0, cree_MACD(16)),
		cree_ligne(SRC_HIGH, MACD, 256, 128.0, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 256, 128.0, cree_MACD(128)),
		cree_ligne(SRC_HIGH, MACD, 256, 256, cree_MACD(32)),
		cree_ligne(SRC_HIGH, MACD, 256, 256, cree_MACD(128)),
		cree_ligne(SRC_HIGH, MACD, 256, 256, cree_MACD(256)),
		cree_ligne(SRC_LOW, MACD, 1, 1, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 1, 2, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 1, 2, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 1, 8, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 1, 8, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 1, 8, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 1, 8, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 2, 1.0, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 2, 2, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 2, 2, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 2, 4, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 2, 4, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 2, 4, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 2, 16, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 2, 16, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 2, 16, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 2, 16, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 4, 2.0, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 4, 2.0, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 4, 4, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 4, 4, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 4, 4, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 4, 8, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 4, 8, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 4, 8, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 4, 32, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 4, 32, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 4, 32, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 8, 4.0, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 8, 4.0, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 8, 8, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 8, 8, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 8, 16, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 8, 16, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 8, 16, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 8, 16, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 8, 64, cree_MACD(64)),
		cree_ligne(SRC_LOW, MACD, 16, 8.0, cree_MACD(1)),
		cree_ligne(SRC_LOW, MACD, 16, 16, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 16, 16, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 16, 16, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 16, 32, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 16, 32, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 16, 32, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 16, 32, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 16, 128, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 16, 128, cree_MACD(64)),
		cree_ligne(SRC_LOW, MACD, 16, 128, cree_MACD(128)),
		cree_ligne(SRC_LOW, MACD, 32, 16.0, cree_MACD(2)),
		cree_ligne(SRC_LOW, MACD, 32, 16.0, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 32, 16.0, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 32, 16.0, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 32, 32, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 32, 32, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 32, 32, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 32, 32, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 32, 64, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 32, 64, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 32, 64, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 32, 256, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 32, 256, cree_MACD(64)),
		cree_ligne(SRC_LOW, MACD, 32, 256, cree_MACD(128)),
		cree_ligne(SRC_LOW, MACD, 32, 256, cree_MACD(256)),
		cree_ligne(SRC_LOW, MACD, 64, 32.0, cree_MACD(4)),
		cree_ligne(SRC_LOW, MACD, 64, 32.0, cree_MACD(8)),
		cree_ligne(SRC_LOW, MACD, 64, 32.0, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 64, 32.0, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 64, 64, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 64, 64, cree_MACD(64)),
		cree_ligne(SRC_LOW, MACD, 64, 128, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 64, 128, cree_MACD(64)),
		cree_ligne(SRC_LOW, MACD, 64, 128, cree_MACD(128)),
		cree_ligne(SRC_LOW, MACD, 256, 128.0, cree_MACD(16)),
		cree_ligne(SRC_LOW, MACD, 256, 128.0, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 256, 128.0, cree_MACD(128)),
		cree_ligne(SRC_LOW, MACD, 256, 256, cree_MACD(32)),
		cree_ligne(SRC_LOW, MACD, 256, 256, cree_MACD(128)),
		cree_ligne(SRC_LOW, MACD, 256, 256, cree_MACD(256)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 1, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 2, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 2, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 8, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 8, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 8, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 1, 8, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 1.0, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 2, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 2, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 4, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 4, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 4, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 16, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 16, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 16, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 2, 16, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 2.0, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 2.0, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 4, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 4, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 4, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 8, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 8, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 8, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 32, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 32, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 4, 32, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 4.0, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 4.0, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 8, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 8, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 16, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 16, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 16, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 16, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 8, 64, cree_MACD(64)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 8.0, cree_MACD(1)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 16, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 16, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 16, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 32, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 32, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 32, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 32, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 128, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 128, cree_MACD(64)),
		cree_ligne(SRC_VOLUMES, MACD, 16, 128, cree_MACD(128)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 16.0, cree_MACD(2)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 16.0, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 16.0, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 16.0, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 32, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 32, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 32, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 32, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 64, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 64, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 64, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 256, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 256, cree_MACD(64)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 256, cree_MACD(128)),
		cree_ligne(SRC_VOLUMES, MACD, 32, 256, cree_MACD(256)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 32.0, cree_MACD(4)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 32.0, cree_MACD(8)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 32.0, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 32.0, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 64, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 64, cree_MACD(64)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 128, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 128, cree_MACD(64)),
		cree_ligne(SRC_VOLUMES, MACD, 64, 128, cree_MACD(128)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 128.0, cree_MACD(16)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 128.0, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 128.0, cree_MACD(128)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 256, cree_MACD(32)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 256, cree_MACD(128)),
		cree_ligne(SRC_VOLUMES, MACD, 256, 256, cree_MACD(256)),
	};
	//
...
#define PERTURBATIONS 0
	//
	printf("Parametres : alpha[0]=%e GRAND_T=%i P_S=%f P_coef=%f\n", alpha[0], GRAND_T, P_S, P_coef);
	//
	uint rep = 0;
	while (1) {
		//perturber(mdl, 1000);
