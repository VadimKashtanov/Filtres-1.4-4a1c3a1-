...
nvcc -c impl/insts/dot1d_tanh/dot1d_tanh_shared.cu      ${A} &
nvcc -c impl/insts/dot1d_tanh/dot1d_tanh_shared_2_16.cu ${A} &
#
nvcc -c impl/insts/dot1d_logistic.cu                   ${A} &
nvcc -c impl/insts/dot1d_logistic/dot1d_logistic_naive.cu       ${A} &
nvcc -c impl/insts/dot1d_logistic/dot1d_logistic_shared.cu      ${A} &
nvcc -c impl/insts/dot1d_logistic/dot1d_logistic_shared_2_16.cu ${A} &
#
nvcc -c impl/insts/dot1d_conn_alea.cu                   ${A} &
nvcc -c impl/insts/dot1d_conn_alea/dot1d_conn_alea_naive.cu       ${A} &
nvcc -c impl/insts/dot1d_conn_alea/dot1d_conn_alea_shared.cu      ${A} &
nvcc -c impl/insts/dot1d_conn_alea/dot1d_conn_alea_shared_2_16.cu ${A} &
#
#
...
#
nvcc -c impl/insts/filtres_tolerant.cu                         ${A} &
nvcc -c impl/insts/filtre_tolerant/filtres_tolerant_naive.cu  ${A} &
nvcc -c impl/insts/filtre_tolerant/filtres_tolerant_shared.cu ${A} &
#
...
#
nvcc -c impl/insts/dot1d_mul.cu                       ${A} &
nvcc -c impl/insts/dot1d_mul/dot1d_mul_shared_2_16.cu ${A} &
#
#	/scores
